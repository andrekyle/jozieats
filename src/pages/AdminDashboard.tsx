...
import { Loader2, LayoutDashboard, Store, Users, ClipboardList, LogOut, Home, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-20">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <p className="text-xs text-muted-foreground font-light tracking-wide">Platform Management</p>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 glass safe-bottom">
        <div className="flex items-center justify-around py-2">
          {TABS.map((t) => (
            <button key={t.id} onClick={() => setTab(t.id)} className={`flex flex-col items-center gap-0.5 px-3 py-1 transition-colors ${tab === t.id ? "text-primary" : "text-muted-foreground"}`}>
